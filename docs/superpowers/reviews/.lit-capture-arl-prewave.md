...
| `--check` | Live smoke test of the load-bearing endpoint forms: DOI singleton, W-id singleton, two-ID batch filter, title search. Prints OK or fail per form. Run on first use and whenever OpenAlex behaves oddly. |
